...
class DiffusionEmbedding(nn.Module):
    def __init__(self, num_steps, embedding_dim=128, projection_dim=None):
        ...
        self.embedding = self._build_embedding(embedding_dim)
    ...
    def _build_embedding(self, embedding_dim, max_positions=10000):
        def embedding(timesteps):
...
class ResidualBlock(nn.Module):
    def __init__(self, side_dim, channels, nheads, is_linear=False):
        super().__init__()
