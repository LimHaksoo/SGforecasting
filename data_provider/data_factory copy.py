...
class Forecasting_Dataset(Dataset):
    def __init__(self, datatype, mode="train", history_length=72):
        ...
        self.date_data = pd.PeriodIndex(self.date_data, freq='h').to_timestamp().values
    ...
    def __getitem__(self, orgindex):
        ...
        s = [self.main_data[index:index+self.history_length],
             self.main_data[index+self.history_length:index+self.seq_length]]
...
def data_provider(args, flag):
    ...
    data_set = Forecasting_Dataset(datatype,mode=flag,history_length=history_length)
